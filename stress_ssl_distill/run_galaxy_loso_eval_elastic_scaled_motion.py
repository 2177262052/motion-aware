...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Run Galaxy LOSO privileged KD training with scaled motion-aware watch encoding."
    )
    ...
    csv_path = output_dir / "galaxy_loso_privileged_scaled_motion_results.csv"
    summary_path = output_dir / "galaxy_loso_privileged_scaled_motion_summary.txt"
    ...
    print(f"Saved Galaxy privileged scaled-motion LOSO CSV to {csv_path}")
    print(f"Saved Galaxy privileged scaled-motion LOSO summary to {summary_path}")
