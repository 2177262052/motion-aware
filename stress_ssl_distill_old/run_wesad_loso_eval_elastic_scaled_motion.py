...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Run WESAD LOSO elastic privileged training with historical scale_logit motion FiLM."
    )
    ...
    csv_path = output_dir / f"{output_prefix}_loso_elastic_scaled_motion_results.csv"
    summary_path = output_dir / f"{output_prefix}_loso_elastic_scaled_motion_summary.txt"
    ...
    print(f"Saved WESAD elastic scaled-motion LOSO CSV to {csv_path}")
    print(f"Saved WESAD elastic scaled-motion LOSO summary to {summary_path}")
