...
from .catsa_dataset import CATSAWatchWindowDataset
...
WATCH_DATASETS = {
    "wesad": WESADWatchWindowDataset,
    "catsa": CATSAWatchWindowDataset,
}
...
def main() -> None:
    ...
    parser.add_argument("--dataset-kind", type=str, default="wesad", choices=sorted(WATCH_DATASETS))
    ...
    dataset_cls = WATCH_DATASETS[args.dataset_kind]
