...
def main() -> None:
    ...
    parser.add_argument("--watch-only-motion-mode", type=str, default="strong", choices=["strong", "residual", "scaled"])
    parser.add_argument("--deploy-watch-enhancement", type=str, default="none", choices=["none", "motion_disentangled", "acc_concat"])
    parser.add_argument("--deploy-watch-motion-mode", type=str, default="strong", choices=["strong", "residual", "scaled"])
    ...
    for subject, manifest_path in manifests:
        ...
        deploy_command = [
            sys.executable,
            "-m",
            "stress_ssl_distill.train_wesad_privileged_elastic",
            "--manifest",
            str(manifest_path),
            "--dataset-root",
            str(args.dataset_root),
