...
from .reliability import cross_calibrated_trust, reliability_bce_loss, trust_weighted_kl_loss
...
def main() -> None:
    ...
    for epoch in range(args.epochs):
        ...
        for batch in progress:
            ...
            reliability_trust = cross_calibrated_trust(
                out["logits"],
                out["teacher_logits"],
                labels,
                quality,
            ...
            epoch_reliability_trust_means.append(float(reliability_trust.mean().detach().cpu().item()))
            ...
            progress.set_postfix(
                ...
                trust=f"{reliability_trust.mean().item():.3f}",
